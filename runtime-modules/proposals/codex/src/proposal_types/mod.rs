...
impl Default for ProposalsConfigParameters {
    fn default() -> Self {
        ProposalsConfigParameters {
            set_validator_count_proposal_voting_period: 50u32,
            set_validator_count_proposal_grace_period: 0u32,
            runtime_upgrade_proposal_voting_period: 150u32,
            runtime_upgrade_proposal_grace_period: 150u32,
            text_proposal_voting_period: 150u32,
            text_proposal_grace_period: 0u32,
            set_election_parameters_proposal_voting_period: 150u32,
            set_election_parameters_proposal_grace_period: 200u32,
            set_lead_proposal_voting_period: 50u32,
            set_lead_proposal_grace_period: 0u32,
            spending_proposal_voting_period: 150u32,
            spending_proposal_grace_period: 30u32,
            add_working_group_opening_proposal_voting_period: 150u32,
            add_working_group_opening_proposal_grace_period: 0u32,
            begin_review_working_group_leader_applications_proposal_voting_period: 50u32,
            begin_review_working_group_leader_applications_proposal_grace_period: 30u32,
            fill_working_group_leader_opening_proposal_voting_period: 50u32,
            fill_working_group_leader_opening_proposal_grace_period: 0u32,
            set_working_group_mint_capacity_proposal_voting_period: 50u32,
            set_working_group_mint_capacity_proposal_grace_period: 0u32,
            decrease_working_group_leader_stake_proposal_voting_period: 50u32,
            decrease_working_group_leader_stake_proposal_grace_period: 0u32,
            slash_working_group_leader_stake_proposal_voting_period: 50u32,
            slash_working_group_leader_stake_proposal_grace_period: 0u32,
            set_working_group_leader_reward_proposal_voting_period: 50u32,
